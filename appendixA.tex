...
\begin{figure}[ht]
  \begin{mathpar}
    ...
    {}
    {[\sigma,(\lambda x. M)\ \dot{V}] \longrightarrow [\sigma,M[\dot{V}/x]]}
    \and
    \inferrule*[right=$\beta$-Pair]
    {}
    {[\sigma,\texttt{let}\ \langle x,y\rangle=\langle \dot{V},\dot{W}\rangle\ \texttt{in}\ M] \longrightarrow [\sigma,M[\dot{V}/x,\dot{W}/y]]}
    \and
    \inferrule*[right=$\beta$-Inj$_0$]
    {}
    {[\sigma,\texttt{match}\ \texttt{inj}_0\ \dot{V}\ [x\Rightarrow M\mid y\Rightarrow N]] \longrightarrow [\sigma,M[\dot{V}/x]]}
    \and
    \inferrule*[right=$\beta$-Inj$_1$]
    {}
    {[\sigma,\texttt{match}\ \texttt{inj}_1\ \dot{V}\ [x\Rightarrow M\mid y\Rightarrow N]] \longrightarrow [\sigma,N[\dot{V}/y]]}
  \end{mathpar}
