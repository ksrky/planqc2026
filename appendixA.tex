...
\begin{figure}[ht]
  \begin{mathpar}
    ...
    {}
    {(\lambda x. M)\ V \longrightarrow_\Lambda M[V/x]}
    \and
    \inferrule*[right=$\beta$-Pair]
    {}
    {\texttt{let}\ \langle x,y\rangle=\langle V,W\rangle\ \texttt{in}\ M \longrightarrow_\Lambda ,M[V/x,W/y]}
    \and
    \inferrule*[right=$\beta$-Inj$_0$]
    {}
    {\texttt{match}\ \texttt{inj}_0\ V\ [x\Rightarrow M\mid y\Rightarrow N] \longrightarrow_\Lambda M[V/x]}
    \and
    \inferrule*[right=$\beta$-Inj$_1$]
    {}
    {\texttt{match}\ \texttt{inj}_1\ V\ [x\Rightarrow M\mid y\Rightarrow N] \longrightarrow_\Lambda N[V/y]}
  \end{mathpar}
