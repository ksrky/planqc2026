...
\begin{figure}[h]
  \begin{mathpar}
    ...
    {}
    { \texttt{let}\ \langle x,y\rangle = \langle V, W\rangle\ \texttt{in}\ N =_\beta N[V/x,W/y] }
    \and
    \inferrule*[right=$\beta$-\textsc{Inj}$_0$]
    {}
    { \texttt{match}\ \texttt{inj}_0\ V\ [x\Rightarrow N\mid y\Rightarrow P] =_\beta N[V/x] }
    \and
    \inferrule*[right=$\beta$-\textsc{Inj}$_1$]
    {}
    { \texttt{match}\ \texttt{inj}_1\ V\ [x\Rightarrow N\mid y\Rightarrow P] =_\beta P[V/y] }
    \and
