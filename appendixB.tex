...
\begin{figure}[h]
  \begin{mathpar}
    \inferrule*[right=$\beta$-\textsc{Lam}]
    {}
    { (\lambda x.M)\ V \longrightarrow M\{V/x\} }
    \and
    \inferrule*[right=$\beta$-\textsc{Let}]
    {}
    { \texttt{let}\ \langle x,y\rangle = \langle V, W\rangle\ \texttt{in}\ N \longrightarrow N\{V/x,W/y\} }
    \and
    \inferrule*[right=$\beta$-\textsc{Inj}$_0$]
    {}
    { \texttt{match}\ \texttt{inj}_0\ V\ [x\Rightarrow N\mid y\Rightarrow P] \longrightarrow N\{V/x\} }
    \and
    \inferrule*[right=$\beta$-\textsc{Inj}$_1$]
    {}
    { \texttt{match}\ \texttt{inj}_1\ V\ [x\Rightarrow N\mid y\Rightarrow P] \longrightarrow P\{V/y\} }
    \and
    \inferrule*[right=\textsc{Cong}]
    { M = N }
    { C[M] = C[N] }
  \end{mathpar}
