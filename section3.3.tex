...
\begin{figure}[t]
  ...
  \begin{mathpar}
    ...
    {[\sigma, \texttt{let}\ \langle x, y\rangle=l_1\ \texttt{in}\ \dot{M}] \longrightarrow \delta_{[\ell^2(f)(\sigma), \dot{M}[l_2/x,l_3/y]]}}
    \and
    ...
    {[\alpha_0\sigma_0 + \alpha_1\sigma_1, \texttt{match}\ l_1\ [y\Rightarrow \dot{M}\mid z\Rightarrow \dot{N}]] \\
    \longrightarrow |\alpha_0|^2 \delta_{[\ell^2(f_0)(\sigma_0), \dot{M}[l_2/y]]} + |\alpha_1|^2\delta_{[\ell^2(f_1)(\sigma_1),\dot{N}[l_3/z]]}}
    \and
